...
shared::BenchResVec iter_count = {1000ul, 1000ul, 1000ul, 1000ul, 1000ul, 1000ul,100ul, 100ul, 100ul, 25ul, 25ul, 5ul, 5ul};//, 25ul, 10ul, 2ul};


BenchmarkRunner benchmarkRunner{ns,iter_count};

shared::BenchResultType BenchmarkRunner::RunSingleBenchmark(size_t N, size_t conf_num ,bool use_omp_outer, int eigen_threads) {
