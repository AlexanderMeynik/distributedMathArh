...
#include <eigen3/Eigen/Geometry>
    ...
    public:
        ...
        Container<Args...> solveFinal();*/ //todo отдельный класс для partial специализации
    ...
    private:
        ...
        template<typename ... Args,template<typename ...> typename Container>//todo создать коцепт для котнейнера сметодами индексации
