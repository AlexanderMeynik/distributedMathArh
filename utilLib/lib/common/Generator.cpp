...
DistributionFunctor ParseFunc(const DistributionType &distribution_type,
  ...
  switch (distribution_type) {
    case DistributionType::NORMAL:return get_normal_generator(args.at("mean"), args.at("dev"));
    case DistributionType::UNIFORM:return get_uniform_generator(args.at("a"), args.at("b"));
    case DistributionType::EXPONENTIAL:return get_exponential_generator(args.at("lambda"));
